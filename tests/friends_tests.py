...
class FriendsTestCase(unittest.TestCase):
    ...
    #         self.assertEqual("Maria has been added to your friend list", add_friend(1))  # add assertion here
    #
    ...
    #     self.assertEqual("Here is a list of your friends: [(1, 'Anna'), (3, 'Jenny')]", show_friends_list(1))
