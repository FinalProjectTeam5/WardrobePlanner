...
class FriendsTestCase(unittest.TestCase):
    def test_add_friend_valid(self):
        with mock.patch('builtins.input', side_effect=['Kim']), mock.patch(
                'WardrobePlanner.classes.db_utils.DBSearch.add_to_friend_list', return_value=["Added"]):
            self.assertEqual(add_friend(1), "Kim has been added to your friend list.")
    ...
    def test_show_friends_list_valid(self):
        self.assertEqual("Here is a list of your friends: Maria, Jenny, Lucy.", show_friends_list(1))
