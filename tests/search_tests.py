...
class TestSearchDashboard(TestCase):
    def test_search_dashboard_user_has_no_clothes_and_no_friends(self):
        user = User(6, "Olga", "W0rdPass", "Львів, Львівська міська громада, Львівський район, Львівська область, "
                                           "Україна", 49.84, 24.03)
    ...
    def test_does_user_have_clothes_no(self):
        user = User(6, "Olga", "W0rdPass",
                    "Львів, Львівська міська громада, Львівський район, Львівська область, Україна", 49.84, 24.03)
