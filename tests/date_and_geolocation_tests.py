...
class Test_CheckCity(TestCase):
    ...
    def test_check_city_city_not_exist(self):
        result = check_city("kjlEFjkgjk")  # this keymash doesn't return results, shockingly many keymashes I tried before this returned legitimate results, it's a very robust module
        expected = None
        self.assertEqual(result, expected)
...
class Test_LocationResultsHandling(TestCase):
    ...
    def test_city_list_for_interface_non_empty_list_passed(self):
        result = city_list_for_interface(
            ...
            'Falenica, Jaźwiny, gmina Borowie, powiat garwoliński, województwo mazowieckie, 08-412, Polska',
            (51.96, 21.78)), (
             'Falenica, Bysławska, Falenica, Wawer, Warszawa, województwo mazowieckie, 04-970, Polska', (52.16, 21.2))])
